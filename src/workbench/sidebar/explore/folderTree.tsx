...
import { type IFolderTree, type IFolderTreeNodeProps } from '@/model';
import { select, getEventPosition } from '@/common/dom';
import Tree, { type ITreeProps } from '@/components/tree';
import { type IMenuItemProps, Menu } from '@/components/menu';
import { Button } from '@/components/button';
import type { IFolderTreeController } from '@/controller/explorer/folderTree';
import { useContextMenu } from '@/components/contextMenu';
import { classNames } from '@/common/className';
import { Scrollbar, useContextViewEle } from '@/components';
import { type ICollapseItem } from '@/components/collapse';
import {
  folderTreeClassName,
