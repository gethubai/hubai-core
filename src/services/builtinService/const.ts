...
import type { IActionBarItemProps, IMenuItemProps } from '@/components';
import type {
  IActivityBarItem,
...
import { ID_SIDE_BAR } from '@/common/id';
      ...
      groupToolbar: [
        {
          ...
          title: localize(constants.EXPLORER_TOGGLE_SAVE_GROUP, 'Save Group'),
          icon: 'save-all',
        },
        {
  ...
  builtInExplorerOutlinePanel: () =>
    ({
      ...
      toolbar: [
        ...
        {
          id: 'outline-more',
          title: localize('sidebar.explore.outlineMore', 'More Actions...'),
          icon: 'ellipsis',
        },
      ],
    } as IExplorerPanelItem),
  ...
  builtInEditorInitialMenu: () =>
    [
      ...
      },
      {
        ...
        name: localize(constants.EDITOR_MENU_CLOSE_TO_RIGHT, 'Close To Right'),
      },
      {
        id: constants.EDITOR_MENU_CLOSE_TO_LEFT,
        name: localize(constants.EDITOR_MENU_CLOSE_TO_LEFT, 'Close To Left'),
      },
      {
        id: constants.EDITOR_MENU_CLOSE_ALL,
        name: localize(constants.EDITOR_MENU_CLOSE_ALL, 'Close All'),
  ...
  builtInReplaceAddons: () =>
    [
      ...
      },
      {
        ...
        title: localize(constants.SEARCH_REPLACE_ALL_COMMAND_ID, 'Replace All'),
        disabled: false,
        checked: false,
        icon: 'replace-all',
      },
          ...
          },
          {
            ...
            data: [
              ...
              },
              {
                ...
                name: localize('menu.showAuxiliaryBar', 'Show Auxiliary Bar'),
              },
              {
                icon: 'check',
                id: constants.MENU_VIEW_STATUSBAR,
                name: localize('menu.showStatusBar', 'Show Status Bar'),
              },
              {
                icon: 'check',
                id: constants.MENU_VIEW_ACTIVITYBAR,
                name: localize('menu.showActivityBar', 'Show Activity Bar'),
              },
              {
                icon: 'check',
