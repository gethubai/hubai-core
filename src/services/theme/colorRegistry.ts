...
const defaultVS = {
  ...
  'scrollbarSlider.hoverBackground': Color.fromHex('#646464').transparent(0.7),
  'scrollbarSlider.activeBackground': Color.fromHex('#000000').transparent(0.6),
...
const defaultDark = {
  ...
  'scrollbarSlider.hoverBackground': Color.fromHex('#646464').transparent(0.7),
  'scrollbarSlider.activeBackground': Color.fromHex('#BFBFBF').transparent(0.4),
...
const defaultHc = {
  ...
  'scrollbarSlider.hoverBackground': Color.fromHex('#6FC3DF').transparent(0.8),
