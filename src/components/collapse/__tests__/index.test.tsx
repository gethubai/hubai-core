...
import { sashItemClassName } from '@/components/split/base';
...
describe('Test The Collapse Component', () => {
  ...
  test('Should uncollapsing the mock2', async () => {
    ...
    expect(mockFn.mock.calls[0][0]).toEqual([undefined, 'mock2', undefined]);
    ...
    expect(mockFn).toHaveBeenCalled();
    expect(mockFn.mock.calls[0][0]).toEqual([undefined, undefined, undefined]);
      ...
      <Collapse
        data={[
          ...
          { id: 'mock2', name: 'test2', config: { grow: 2 } },
          {
            id: 'mock3',
            name: 'test3',
            renderPanel: () => <div data-testid="test" />,
          },
        ]}
        onResize={mockResize}
      />
